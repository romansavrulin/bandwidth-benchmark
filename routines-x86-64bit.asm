...
_Reader_128bytes:
	...
	add	P2, P1	; P1 now points to end.
...
.L2:
	vmovdqu64	[r10], zmm0
	vmovdqu64	[64+r10], zmm0
	vmovdqu64	[128+r10], zmm0
	vmovdqu64	[192+r10], zmm0
...
Register8ToVector:
_Register8ToVector:
	sal	P1, 2  	; Force some repetition.
.L1:
...
Register16ToVector:
_Register16ToVector:
	sal	P1, 1  	; Force some repetition.
.L1:
...
Vector8ToRegister:
_Vector8ToRegister:
	sal	P1, 3  	; Force some repetition.
.L1:
...
_CopySSE_128bytes:
	...
	shr	P3, 7	; Ensure length is multiple of 128.
	shl	P3, 7
